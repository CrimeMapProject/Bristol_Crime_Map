...
The interactive geospatial maps generated by this pipeline are hosted live via GitHub Pages. You can experience the dynamic point-cluster and heatmap features directly in your browser using the links below:

🔗 **[Click Here to Open the Interactive Point-Cluster Map](https://crimemapproject.github.io/Bristol_Crime_Map/bristol_crime_map.html)**

🔗 **[Click Here to Open the Live Dynamic Crime Heatmap](https://crimemapproject.github.io/Bristol_Crime_Map/bristol_crime_heatmap.html)**
